...
export default function Navbar() {
    ...
    const [showingNavigationDropdown, setShowingNavigationDropdown] =
        ...
        : "null";
    return (
        <nav className="hidden my-4 bg-white border rounded md:block">
                                    ...
                                    <Dropdown>
                                        <Dropdown.Trigger>
                                            <span className="inline-flex rounded">
                                                <button
                                                    type="button"
                                                    className="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out bg-white border border-transparent rounded hover:text-gray-700 focus:outline-none"
                                                >
                                                    Permission
                                                    <svg
