  ...
  return (
    <div>
      <Transition  appear show={isOpenExportDialog} as={Fragment}>
        <Dialog as="div" className="relative z-10" open={isOpenExportDialog} onClose={()=> {}}>
          <Transition.Child
            as={Fragment}
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex items-baseline justify-center min-h-full p-4 text-center">
              ...
              >
                <Dialog.Panel className={`w-full transform rounded bg-white p-6 text-left align-middle shadow-xl transition-all ${size}`}>
                  <Dialog.Title
                    as="h3"
